            ...
            <div className='my-[80px]'>
                <div className='flex'>
                    <div className='lg:flex'>
                        <div className='lg:flex-[.69] border border-blackColor p-8 h-fit backdrop-blur-md'>
                        ...
                        <div className='lg:flex-1'>
                            ...
                            <div className='flex-1 border border-blackColor lg:mr-[80px] p-8 backdrop-blur-md'>
